                ...
                {categories.length > 0 ? (
                    <SimpleGrid columns={{ base: 2, sm: 3, md: 4, lg: 5 }} spacing={{ base: 4, md: 6 }}>
                        {categories.map((category) => (
                            ...
                            >
                                <Box h={{ base: "140px", md: "180px" }} bg="gray.50" position="relative" overflow="hidden">
                                    {category.image?.url ? (
                                        <Image
                                        ...
                                        <Flex h="100%" w="100%" justify="center" align="center" bg="gray.100" color="gray.400">
                                            <Text fontSize="xs" fontWeight="medium">No Image</Text>
                                        </Flex>
                                    )}
                                </Box>
                                <Box p={{ base: 3, md: 4 }} textAlign="center">
                                    <Heading size="xs" fontSize={{ base: "sm", md: "md" }} fontWeight="bold" color="gray.700" textTransform="capitalize" noOfLines={1}>
                                        {category.name}
                                    </Heading>
                                </Box>
                            </Box>
