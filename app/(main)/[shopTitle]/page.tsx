...
const Page = observer(() => {
  ...
  return (
    <Box>
      {shopData ? <ShopPage shopData={{...shopData, images : dummyData.images, operatingHours : dummyData.operatingHours, ratings : dummyData.ratings}} /> : <Text>No shop data available.</Text>}
    </Box>
  );
});
