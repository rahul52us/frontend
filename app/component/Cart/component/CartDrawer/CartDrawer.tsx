...
const CartDrawer = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
  const [cartItems, setCartItems] = useState<CartItem[]>([
    {
      id: 1,
      name: 'Kwality Wall\'s Cornetto Double Chocolate Ice Cream Cone',
      image: '/images/product/watch.webp',
      price: 50,
      quantity: 2
    },
    {
      id: 2,
      name: 'Premium Analog Watch with Leather Strap',
      image: '/images/product/watch.webp',
      price: 14200,
      quantity: 1
    }
        ...
        <DrawerContent borderLeftRadius={'2xl'} maxW={{ lg: '28rem' }}>
          <DrawerHeader shadow={'md'} borderBottomRadius={"lg"} py={6}>
            <Flex gap={3} align={'center'}>
              ...
              <Text fontSize={'lg'} fontWeight={600} color={'purple.700'}>Your Cart ({cartItems.length})</Text>
            </Flex>
          </DrawerHeader>
