          ...
          <VStack spacing={5} align="stretch">
            ...
            >
              ...
              <HStack>
                ...
                <Button colorScheme="blue" size="sm" px={8} borderRadius="full">
                  Apply Insights
                </Button>
              </HStack>
            </Flex>
          ...
          >
            ...
            <VStack mt={10} spacing={4}>
              {[
                ...
                >
                  <HStack>
                    <Box boxSize={2} borderRadius="full" bg={item.c} />
  ...
  >
    ...
    <Flex justify="space-between" align="start">
      <VStack align="start" spacing={1} flex={1}>
        ...
        <HStack>
          <Icon
            as={isUp ? FaChartLine : FaChartLine}
            color={isUp ? "green.400" : "red.400"}
            transform={isUp ? "" : "rotate(90deg)"}
          />
          <Text
            fontSize="xs"
            fontWeight="bold"
